...
Setup k3[] { // SlowCurve,Curve, FastCurve, Straight, Stop
  ...
  {0.40, 0.00030, 0.000000, 0.0000035},
  // {0.70, 0.00020, 0.000000, 0.0000060},
  // {0.85, 0.00022, 0.000000, 0.000015},
  {0.50, 0.00020, 0.000000, 0.0000045},
  {0.85, 0.00022, 0.000000, 0.000035},
  // {1.00, 0.00022, 0.000000, 0.000025},
  // {0.85, 0.00014, 0.000000, 0.0000150},
  {1.00, 0.00022, 0.000000, 0.000030},
  {0.10, 0.00010, 0.000000, 0.0000010}
};

Setup k4_M10_1[] { // SlowCurve,Curve, FastCurve, Straight, Stop
  // MOTORS 10:1  120mm x 75mm
  {0.20, 1.00, 0.000, 0.075},
  {0.30, 1.00, 0.000, 0.075},
  // {0.50, 0.75, 0.000, 0.15},
  {0.85, 0.500, 0.000, 0.070},
  {1.00, 0.510, 0.000, 0.070},
  {0.10, 0.50, 0.000, 0.075}
};
